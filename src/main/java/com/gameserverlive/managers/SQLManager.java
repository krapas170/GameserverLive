...
public class SQLManager {
	...
	public static void onCreate() throws InterruptedException {
		...
		LiteSQL.onUpdate("CREATE TABLE IF NOT EXISTS gameserver(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, game TEXT, adress TEXT, port INTEGER, guildid INTEGER, channelid INTEGER)");
	}
}